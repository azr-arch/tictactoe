...
const StartGame = () => {
    ...
    const [currPlayer, setCurrPlayer] = useState(LocalStorage.get("user") || null);
            ...
            {loading && (
                <div className="w-screen flex items-center z-50 justify-center h-screen  fixed top-0 left-0 bg-black bg-opacity-50">
                    <div className="bg-black_1 rounde-md p-4 text-white text-center">
                        ...
                        {/* <p className="text-sm black f</p> */}
                        <p className=" font-medium text-sm mt-4">
                            Share this Room Id, to other player
                        </p>
                        <div className="w-full flex items-center justify-between ring-1 mt-4 ring-white px-4 rounded-sm bg-black_2">
                            <code className="py-3 font-mono text-sm text-white font-semibold">
                                {createdRoom}
                            </code>

                            <BiCopy
                                className="w-4 h-4 cursor-pointer hover:opacity-50"
                                onClick={onCopy}
                                title="copy"
                            />
                        </div>
